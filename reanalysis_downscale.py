...
# mac
# filedem_era = './DEM/JAR55_DEM2.mat'
# inpath = '/Users/localuser/Research/Test'
# outpath = '/Users/localuser/Research'
# plato
filedem_era = '/datastore/GLOBALWATER/CommonData/EMDNA/DEM/JAR55_DEM2.mat'
inpath = '/datastore/GLOBALWATER/CommonData/EMDNA/JAR55_day_raw'  # downscale to 0.1 degree
outpath = '/home/gut428'
file_readownstn = outpath + '/JAR55_downto_stn_' + downtostn_method + '.npz'  # downscale to station points (1979-2018)
filenear = '/datastore/GLOBALWATER/CommonData/EMDNA/JAR55_day_ds/weight_dem.npz'
...
#         infile = inpath + '/JAR55_' + vars[v] + '_' + str(y) + '.mat'
#         outfile_grid = outpath + '/JAR55_' + vars[v] + '_' + str(y) + '.npz'
...
if not os.path.isfile(file_readownstn):
    ...
    flag = 0 # should start from 365 for JAR55
    for y in range(year[0], year[1]+1):
        print('Downscale to station: year', y)
        # prcp downscaling
        infile = inpath + '/JAR55_prcp_' + str(y) + '.mat'
        file_readownstny = outpath + '/JAR55_downto_stn_' + downtostn_method + str(y) + '.npz'
        ...
        if os.path.isfile(file_readownstny):
            ...
            # tmin downscaling
            infile = inpath + '/JAR55_tmin_' + str(y) + '.mat'
            datatemp = {}
            f = h5py.File(infile, 'r')
            for k, v in f.items():
                datatemp[k] = np.array(v)
            ...
            # tmax downscaling
            infile = inpath + '/JAR55_tmax_' + str(y) + '.mat'
            datatemp = {}
            f = h5py.File(infile, 'r')
            for k, v in f.items():
                datatemp[k] = np.array(v)
...
# outpath = '/home/gut428/JAR55_day_ds'
# for y in range(1979,2019):
#     print(y)
#     infile1 = outpath + '/JAR55_tmin_' + str(y) + '.npz'
#     infile2 = outpath + '/JAR55_tmax_' + str(y) + '.npz'
#     outfile1 = outpath + '/JAR55_tmean_' + str(y) + '.npz'
#     outfile2 = outpath + '/JAR55_trange_' + str(y) + '.npz'
