...
FileRegError_daily = '/Users/localuser/GMET/pyGMET_exp/regress_daily_error_boxcox_rea.npz'  # regression error at station points
...
if cai_mode == 0 or daily_flag == 1:
    if os.path.isfile(FileRegError_daily) and ow_daily != 1:
        ...
        pcp_err_stn_daily, tmean_err_stn_daily, trange_err_stn_daily = \
            reg.station_rea_error(prcp_stn_daily, tmean_stn_daily, trange_stn_daily, stninfo, near_stn_prcpLoc,
